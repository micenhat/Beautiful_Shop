...
Route::group(['prefix'=>'admin','middleware'=>'auth'],function(){
	...
	Route::group(['prefix'=>'user'],function(){
		...
		Route::get('y-kien',['as'=>'getYkien','uses'=>'welcomeController@get_ykien']);
		Route::post('y-kien',['as'=>'postYkien','uses'=>'welcomeController@post_ykien']);
		...
		Route::get('kiemtra-sanpham',['as'=>'checkout','uses'=>'welcomeController@checkout']);

		Route::get('dang-ki',['as'=>'getRegister','uses'=>'welcomeController@get_register']);
		Route::post('dang-ki',['as'=>'postRegister','uses'=>'welcomeController@post_register']);
