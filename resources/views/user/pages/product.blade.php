@extends('user.master')
@section('description','Đây là trang Product')
@section('content')
<!-- Header End -->
      ...
      <ul class="thumbnails">
        <li class="span3">
          ...
          <div class="thumbnail">
            ...
            <a href="{!! url('chi-tiet-san-pham',[$item->id,$item->alias]) !!}"><img alt="" src="{!! asset('resources/upload/'.$item_featured_product->image) !!}"></a>
            <div class="pricetag">
              <span class="spiral"></span><a href="{!! url('mua-hang',[$item->id,$item->alias]) !!}" class="productcart">ADD TO CART</a>
              <div class="price">
                <div class="pricenew">{!! $name_cate->name !!}</div>
                <div class="priceold">{!! number_format($item_featured_product->price,0,",",".") !!} VNĐ</div>
              </div>
            </div>
          </div>
        </li>
