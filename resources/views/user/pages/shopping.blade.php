@extends('user.master')
@section('description','Đây là trang gior hàng')
@section('content')
     ...
     <!--  breadcrumb --> 
        ...
        <table class="table table-striped table-bordered">
          ...
          <tr>
            ...
            <td class="quantity"><input  class="span1 qty" type="text" size="1" value='{!! $item["qty"] !!}' name="quantity[40]" /></td>
             <td class="action"> <a href="#" class="updateCart" id ="{!! $item['rowid'] !!}"><img class="tooltip-test" data-original-title="Update" src="{!! asset('public/user/img/update.png') !!}" alt=""></a>
      ...
      <div class="pull-right">
          <div class="span4 pull-right">
            ...
            <input type="submit" value="Continue Shopping"  href="{!! url('/') !!}" class="btn btn-orange pull-right mr10" >
          </div>
        </div>
        </div>
    </div>
