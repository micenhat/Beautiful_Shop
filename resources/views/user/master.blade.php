...
<head>
<meta charset="utf-8">
<title>Beautiful_Shop</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="description" content="@yield('description')">
<meta name="author" content="Nhat Hung">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="span3 contact">
          <h2>Contact Us </h2>
          <ul>
            <li class="phone"> +05113 xxxx</li>
            <li class="mobile"> +0905 132241</li>
            <li class="email"> nhathungmen111@gmail.com</li>
            <li class="email"> micenhatdev@gmail.com</li>
          </ul>
        </div>
  ...
  <section class="copyrightbottom">
    <div class="container">
      <div class="row">
        ...
        <div class="span6 textright"> Beautiful_Shop@2016 </div>
      </div>
    </div>
  </section>
